---
title: 判断力不是护城河，是水源：我如何把人放进 AI 回路里
...
Agrawal、Gans 和 Goldfarb 在 [《Prediction Machines》](https://www-2.rotman.utoronto.ca/insightshub/ai-analytics-big-data/prediction-machines-simple-eco) 中给出了一个清晰框架：任何决策都可以拆解为五个要素——数据、预测、判断、行动和结果。原书的核心经济学论证很简洁：AI 本质上是一种预测技术，它把预测的成本打了下来。经济学告诉我们，当一个东西变便宜，它的互补品就会升值。预测的互补品是判断——每一次预测都需要一个"我要什么"来配对，才能变成决策。所以预测越便宜、越泛滥，判断的需求就越大、价值就越高。
...
原书写于 2018 年，彼时 AI 的主要角色还是预测引擎。但到了 agent 时代，我认为变化不止于此：行动也在变便宜。模型不只给你一个预测结果，它还能直接写代码、调 API、部署服务、跑完整个工作流。预测和行动同时被压低成本之后，决策链条里真正留给人的就剩三件事：提供上下文、行使判断、承担结果。

但这三件事的性质并不相同。上下文和判断，人可以主动经营。结果则不一样——AI 能接收到结果的反馈信号（测试通过了、用户投诉了、指标掉了），但它无法真正承担结果的后果。模型没有利害关系，没有声誉要维护，没有不可逆的损失要吞下。更深一层说，很多结果的含义需要在特定业务语境和价值体系里才能被理解：一个指标下降 2% 是灾难还是噪声，取决于你对业务周期和用户行为的整体认知，这不是模型能替你判断的。所以"承担结果"不是一种能力，更接近一种不可让渡的责任——人在回路里的最终锚点。

回到上下文。我更愿意把原书里的"数据"展开成"上下文"。真正稀缺的不是一条条孤立信息，而是它们背后的业务语境：用户画像、场景约束、资源边界、竞品动态、组织内隐性知识、某个项目过去踩过的坑。模型的上下文窗口终究有限且易逝，而人的上下文可以跨越时间积累。上下文让判断有了锚点，让价值权衡不再是空中楼阁。
...
所以这套回路对我来说，不是一组"让 AI 干更多活"的技巧，而是一个把人放进协作中心的方法。探测不是为了让 AI 替我想，而是防止我带着盲区开始；发散不是为了多几个选项，而是逼出我的隐性偏好；拷问不是为了显得严谨，而是防止我被顺滑叙事带走；解释和走读不是交付后的包装，而是让我重新获得参与下一轮决策的能力。

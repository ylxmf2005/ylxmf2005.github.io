...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "AI, cognition, and what's left for humans to decide",

	// 站点 URL
	site_url: "https://ylxmf2005.github.io",

	// 站点描述
	description: "Ethan Lee's blog on AI, cognition, and human judgment.",

	// 站点关键词
	keywords: ["Ethan Lee", "Yifeng Li", "个人博客"],
